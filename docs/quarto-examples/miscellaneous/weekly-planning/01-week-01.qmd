...
| WEEK 1      	| MONDAY (W16)                 	        | TUESDAY (W24)                         | WEDNESDAY (W24)                       | THURSDAY (W34)                            | FRIDAY (W34)                     	|
|-----------	|---                           	        |---	                                |---	                                |---	                                    |---	|
| Morning   	| ~~CP: Review GitHub issues (W3)~~         | TP: Do a weekly scrum	(W8)            | ~~CP: Add HTTP Session login (W8)~~        | TP: Update OpenProject tasks (W8)         | CI/CD: Learn GitHub Actions (W13)  	|
