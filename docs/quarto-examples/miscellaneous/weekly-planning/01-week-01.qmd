...
| WEEK 1      	| MONDAY (W16)                 	        | TUESDAY (W24)                         | WEDNESDAY (W24)                       | THURSDAY (W47)                            | FRIDAY (W34)                     	|
|-----------	|---                           	        |---	                                |---	                                |---	                                    |---	|
| Morning   	| ~~CP: Review GitHub issues (W3)~~         | ~~TP: Do a weekly scrum	(W8)~~            | ~~CP: Add HTTP Session login (W8)~~        | ~~TP: Update OpenProject tasks (W8)~~ TP: Finish User Entity (W13)         | CI/CD: Learn GitHub Actions (W13)  	|
| Afternoon 	| ~~TP: Review Team project status (W5)~~      | ~~CP: Update Quarto docs (W3)~~      | CP: Create Library REST API (W8)          | CP: Migrate H2 to another database (W13)  | DOL: Install a SMTP server (W13)   	|
