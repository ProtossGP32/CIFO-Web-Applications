...
| WEEK 1      	| MONDAY (W34)                 	            | TUESDAY (W26)                         | WEDNESDAY (W32)                       | THURSDAY (W34)                            | FRIDAY (W37)  |
|-----------	|---   	                                    |---                                    |---	                                |---                                        |---    |
| Morning   	| ~~PMS: Weekly planning (W8)~~                 | TP: Update UMLs (W5)                  | DOL: Update Quarto docs (W3)          | TP: Finish Vertical Slicing designs (W13) | TP: Update functional diagrams (W8)  	|
| Afternoon 	| TP: Finish User Entity (W13)              | DOL: Learn about observability (W13)  | DOL: Learn about Argo workflows (21)  | DOL: Learn about Python and Flask (13)    | DOL: Learn about OKD (21)  	|
| Evening   	| CP: Complete SonarQube GitHub action (W13)| CP: Create Library REST API (W8)      | CP: Create missing Unit Tests (W8)    | TP: Create missing Unit Tests (W8)        | PMS: Weekly retrospective (W8)    |
...
- CP: Complete SonarQube GitHub action (W13) --> Worked on it on Monday morning, still not finished (missing Code coverage)
- Offtopic: Work with KiCAD 6 --> Done instead of Monday tasks
