---
title: "09 - Week 09"
description: "Weekly planning iteration"
...
- Create a REST API application with SpringBoot and ReactJS
...
- Deploy an OKD cluster using OpenStack as the provider infrastructure
...
| BSC       | Deploy OKD cluster                | 21        | Week 8
| BSC       | Create docs and publish them      | 8         | Week 8
...
- Important but not urgent:
    - BSC: Create docs and publish them (W8)
...
|-----------	|---   	                                        |---                                        |---	                                |---                                        |---    |
| Morning   	| ~~DOL: Learn about OpenStack (W21)~~ | ~~PMS: Weekly planning (W8)~~ CP: Finish React Lab-RE02-1 (W8) |  CP: Enable logging in Java ~~(W8) TP: Finish User Entity (W13)~~ | CP: Finish React Lab-RE03-1 (8) ~~TP: Finish User Entity (W13)~~ | TP: Update functional diagrams (W8) CP: Finish MongoDB tutorials (W8) |
| Afternoon 	| ~~DOL: Learn about OpenStack (W21)~~ | ~~BSC: Deploy OKD cluster (W21)~~  | ~~BSC: Deploy OKD cluster (W21)~~   | ~~BSC: Deploy OKD cluster (W21)~~          | ~~BSC: Deploy OKD cluster (W21)~~  	|
| Evening   	| ~~DOL: Learn about OpenStack (W21)~~ | ~~DOL: Learn about OKD (21)~~ | DOL: Learn about Argo workflows (21)CP: Create missing Unit Tests (W8)    | TP: Create missing Unit Tests (W8) | TP: Enable logging (W5) PMS: Weekly retrospective (W8)    |
...
- Morning: BSC Tensorflow
- Afternoon: BSC OKD + Floki
- Evening: Nothing

#### Tuesday:

- Morning: BSC + React LabRE03-1
- Afternoon: BSC OKD
- Evening: Nothing

#### Wednesday:

- Morning: BSC + React LabRE03-2
- Afternoon: BSC OKD
- Evening: 

#### Thursday:

- Morning: BSC + ReactJS LabRE03-2
- Afternoon: BSC OKD
- Evening: 

#### Friday:

- Morning: BSC + Weekly retrospective + 
- Afternoon: BSC
- Evening:
...
- **Best decision of all week**
    - Document all the OKD deployment attempts
        - Now we can explain with more detail how OpenStack and OpenShift/OKD works and what they expect to work well

- **Avoided pits**
    - Unavoided pit: OKD deployment

- **What have you reorganized during this week?**
    - 

- **Core concepts learnt during this week / What have you learned?**
    - How to deploy an OKD on a restricted OpenStack platform
    - 
...
- React:
    - Contexts, To-Do app
- MongoDB:
    - Finish tutorials, apply it in your projects
- Retrospective:
    - Have you been alive this last week?