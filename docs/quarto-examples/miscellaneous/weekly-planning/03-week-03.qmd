...
|-----------	|---   	                                        |---                                        |---	                                |---                                        |---    |
| Morning   	| ~~PMS: Weekly planning (W8)~~                 | ~~CP: Complete SonarQube GitHub action (W13)~~| CP: Enable logging in Java (W8) ~~CP: Work on REST API controllers (W8)~~      | CP: Swagger and Mockito into Library (W8)                                  | TP: Update functional diagrams (W8)  	|
