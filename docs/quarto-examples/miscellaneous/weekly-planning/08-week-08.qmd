...
|-----------	|---   	                                        |---                                        |---	                                |---                                        |---    |
| Morning   	| BSC | PMS: Weekly planning (W8) CP: Finish React Lab-RE02-1 (W8) |  CP: Enable logging in Java (W8) TP: Finish User Entity (W13) | CP: Finish React Lab-RE03-1 (8) TP: Finish User Entity (W13)| TP: Update functional diagrams (W8) CP: Finish MongoDB tutorials (W8) |
| Afternoon 	| BSC | BSC: Deploy OKD cluster (W21)  | BSC: Deploy OKD cluster (W21)   | BSC: Deploy OKD cluster (W21)          | BSC: Deploy OKD cluster (W21)  	|
| Evening   	| BSC | DOL: Learn about OKD (21) | DOL: Learn about Argo workflows (21)CP: Create missing Unit Tests (W8)    | TP: Create missing Unit Tests (W8) | TP: Enable logging (W5) PMS: Weekly retrospective (W8)    |
...
- Morning: BSC + React LabRE02-1
- Afternoon: BSC
- Evening: 

#### Wednesday:

- Morning: BSC (Correctly deploy OKD using OpenStack installer) + React LabRE03-1
- Afternoon: BSC
- Evening: 

#### Thursday:

- Morning: BSC (Create OKD / OpenShift installation docs) + React LabRE03-1 
- Afternoon: BSC (Failed deploying OKD from local machine)
- Evening: 

#### Friday:

- Morning: BSC + Weekly retrospective + ReactJS To-Do contexts
- Afternoon: BSC
- Evening:
...
- **Best decision of all week**
    - Only working on the course during mornings
    - Documentation of the OpenShift deployments
